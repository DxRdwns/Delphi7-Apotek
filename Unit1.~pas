...
Editkode.Text := DBGrid1.Fields[0].AsString;
Editnama.Text := DBGrid1.Fields[1].AsString;
Editharga.Text := DBGrid1.Fields[2].AsString;
DateTimePickerumur.Date := DBGrid1.Fields[3].AsDateTime;
Editstok.Text := DBGrid1.Fields[4].AsString;
Editkode.SetFocus;
end;
